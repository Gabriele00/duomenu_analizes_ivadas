...
#ALT1: iportuojame iš curl url pagalba sukurto failo
## nebuvau labai reiklaus, dėl header=TRUE ar FALSE
census <- read.csv("census.csv", header = FALSE, stringsAsFactors = FALSE)
 
#ALT2: nuskaityti duomenis tiesiai į R
url <- "https://archive.ics.uci.edu/ml/machine-learning-databases/adult/adult.data"
census <- read.csv(url, sep=",", header = FALSE, stringsAsFactors = FALSE)

#arba

census <- read.csv(file="https://archive.ics.uci.edu/ml/machine-learning-databases/adult/adult.data",
                   sep=",",
                   header = FALSE, 
